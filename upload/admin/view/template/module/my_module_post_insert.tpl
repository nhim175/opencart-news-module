        ...
        <table class="form">
          <tbody>
            <tr>
              ...
              <td><input type="text" name="post_title" value="" size="100" /></td>
            </tr>
            <tr>
        ...
        <table class="form">
          <tbody>
            <tr>
              ...
              <td>
                <div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb" /><br />
                <input type="hidden" name="post_img" value="" id="image" />
